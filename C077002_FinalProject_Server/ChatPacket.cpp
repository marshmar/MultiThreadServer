...
ChatPacket::ChatPacket(HEADER header, char id, short length, short endMarker)
...
void ChatPacket::Serialize(std::vector<char>& buffer) {
	short offset = 0;
	buffer.clear();
...
void ChatPacket::DeSerialize(std::vector<char>& buffer) {
	short offset = 0;
...
void ChatPacket::PrintItem() const {
